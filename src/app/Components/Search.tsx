...
const Search = () => {
  return (
    <div className='flex justify-center items-center mt-[-30px] mb-8 w-full pt-8 px-4 sm:px-6'>
      <div className='bg-[rgb(193,211,246)] rounded-3xl flex flex-row items-center justify-between gap-4 w-full max-w-7xl mx-auto h-auto md:h-16 px-4 sm:px-6 py-3 shadow-lg'>

      
        <div className='flex items-center gap-3  px-3 py-3 bg-white rounded-xl text-black shadow-md'>
          <img src="/icons/calendar.svg" alt="person icon" className="w-5 h-5" />
          <p className='text-sm'>Check available</p>
        </div>

        <div className='flex items-center gap-4 px-4 py-2 bg-white rounded-xl text-black shadow-md'>
        ...
        <div className='flex items-center gap-2 px-4 py-2 bg-white rounded-xl text-black shadow-md'>
